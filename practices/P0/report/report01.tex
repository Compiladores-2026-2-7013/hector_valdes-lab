...
./ejecutable
\end{lstlisting}
  \caption{Comando para ejecutar el programa ejecutable}
\end{figure}
...
\end{lstlisting}
\caption{\textit{Extracto de programaPI.i}}
\end{figure}
...
./ejecutable02
\end{lstlisting}
  \caption{Comando para ejecutar el nuevo programa ejecutable}
\end{figure}
...
Resultado : 28.274334
\end{lstlisting}
  \caption{Salida de el nuevo programa ejecutable}
\end{figure}
